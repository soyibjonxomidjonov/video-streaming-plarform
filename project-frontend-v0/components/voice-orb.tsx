  ...
  if (minimized) {
    return (
      <button
        ...
        className="fixed right-0 top-1/2 z-50 flex h-20 w-3 -translate-y-1/2 items-center justify-center rounded-l-xl bg-primary shadow-lg transition hover:w-4"
      >
          ...
          {pendingConfirm && (
            <div className="mt-3 flex justify-end gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-border bg-surface px-3 py-1 text-xs font-semibold text-muted-foreground"
              >
                Yo&apos;q
              </button>
            </div>
      ...
      >
        ...
        <span
          className={`relative flex size-12 items-center justify-center rounded-full shadow-xl transition-all ${
            enabled ? 'glow-primary bg-primary text-primary-foreground' : 'border border-border bg-surface text-muted-foreground'
          }`}
        >
