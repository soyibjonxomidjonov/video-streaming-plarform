          ...
          {allHistory.map(record => {
            ...
            return (
              <Link
                ...
                href={href}
                className="group flex items-center gap-3 rounded-2xl p-2.5 transition hover:border-amber-400/50 sm:gap-3.5 sm:p-3"
                style={{ background: '#16161a', border: '1px solid #2a2a30' }}
              >
                {/* Poster / Thumbnail */}
                <div className="relative aspect-video w-20 shrink-0 overflow-hidden rounded-xl bg-surface-2 sm:w-24">
                  {img && (
