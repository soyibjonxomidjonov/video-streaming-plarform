    ...
    <div>
      ...
      <div className="mb-5 flex flex-col gap-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            style={showFilters || hasFilters ? { background: '#f5a623' } : {}}
          >
            <Filter size={16} />
            <span className="hidden sm:inline">Filtr</span>
            {hasFilters && (
              <span className="flex size-4 items-center justify-center rounded-full bg-black text-[10px] font-bold text-amber-400">!</span>
            )}
          </button>
        </div>
                  ...
                  <button
                    ...
                    style={
                      ordering === opt.value
                        ...
                        : { background: '#202024', color: '#9a9aa2' }
                    }
                  >
                    {opt.label}
                  </button>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-border py-16 text-center">
          ...
          {hasFilters && (
            <button onClick={clearFilters} className="text-sm font-semibold" style={{ color: '#f5a623' }}>
              Filtrlarni tozalash
            </button>
          )}
        </div>
