      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="relative rounded-3xl p-6 sm:p-10" style={{ background: '#16161a', border: '1px solid #2a2a30' }}>
          ...
          <button
            ...
            className="absolute top-6 right-6 flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold transition active:scale-95 disabled:opacity-50"
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl p-4" style={{ background: '#202024', border: '1px solid #2a2a30' }}>
              <p className="text-3xl font-black">{loading ? <Loader2 size={22} className="animate-spin text-muted-foreground"/> : favorites.length}</p>
            ...
            <div className="rounded-2xl p-4" style={{ background: '#202024', border: '1px solid #2a2a30' }}>
              <p className="text-3xl font-black">{loading ? <Loader2 size={22} className="animate-spin text-muted-foreground"/> : historyCount}</p>
              <p className="mt-1 text-xs text-muted-foreground flex items-center gap-1">
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold transition text-red-400 hover:bg-red-500/10"
