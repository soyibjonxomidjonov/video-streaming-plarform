  ...
  return (
    <AppChrome>
      <div className="flex flex-col gap-6">
        ...
        {/* Navigation Tabs */}
        <div className="flex flex-wrap gap-1.5 rounded-2xl p-1.5" style={{ background: '#16161a', border: '1px solid #2a2a30' }}>
          {(
            [
            ...
            <section className="rounded-2xl p-6" style={{ background: '#16161a', border: '1px solid #2a2a30' }}>
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between gap-3 rounded-xl p-3 text-xs" style={{ background: '#202024' }}>
