    ...
    <div className="w-full min-w-0 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="w-full p-6 sm:p-8 rounded-3xl bg-[#0F171A] border border-[#00FFA3]/15 flex flex-col sm:flex-row items-center gap-6">
        <div className="relative shrink-0">
          <div className="size-28 sm:size-32 rounded-3xl border-2 border-[#00FFA3] shadow-[0_0_30px_rgba(0,255,163,0.3)] overflow-hidden">
            {profileAvatar ? (
          ...
          <button
            ...
            className="absolute -bottom-2 -right-2 flex size-10 items-center justify-center rounded-xl border border-[rgba(0,255,163,0.3)] bg-[#141F24] text-[#00FFA3] shadow-lg transition hover:bg-[#00FFA3] hover:text-[#070A0C] hover:scale-110"
