  ...
  return (
    <div className="flex w-full flex-col gap-2">
      <button
        ...
        onClick={() => login()}
        disabled={loading}
        className="group relative flex w-full min-h-[52px] items-center justify-center gap-3 overflow-hidden rounded-xl border border-[rgba(0,255,163,0.18)] bg-[#0F171A] px-5 text-[13.5px] font-semibold text-[#94A3B8] transition-all duration-200 hover:border-[rgba(0,255,163,0.45)] hover:bg-[#0B1310] hover:text-[#E2E8F0] hover:shadow-[0_0_20px_rgba(0,255,163,0.12)] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
      >
        {loading ? (
          <>
            <Loader2 className="h-[18px] w-[18px] animate-spin text-[#00FFA3]" />
      ...
      {error && (
        <p role="alert" className="text-center text-xs font-bold text-[#EF4444]">
          {error}
        </p>
      )}
    </div>
